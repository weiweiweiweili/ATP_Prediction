...
def test_predict():
	...
	user_inputs.loc[0] = pd.Series({'player_ht_diff': 0, 'player_age_diff': 0, 'player_rank_diff': 0, 'player_rank_points_diff': 0, 'surface_clay': 1, 'surface_grass': 0, 'surface_hard': 0, 'tourney_level_A': 1, 'tourney_level_G': 0, 'tourney_level_M': 0})
	...
	print ('Test for model function passed!')
